...
return [
    ...
    '月光下的异世界之旅S2' => [
        'query' => [
            'keyword' => '月光下的异世界之旅  第二季',
            'team_id' => '816', //ANi
        ],
    ],
    '杀手寓言' => [
        'query' => [
            'keyword' => '杀手寓言 GB_MP4 1920',
            'team_id' => '241', //幻婴
        ],
    ],
    '无职转生S2' => [
        'query' => [
            'keyword' => '无职转生 S2 1080p 简繁内封',
            'team_id' => '619', //桜都字幕组
        ],
    ],
    '素晴S3' => [
        'query' => [
            'keyword' => '为美好的世界献上祝福 第三季 简日双语',
            'team_id' => '47', //爱恋
        ],
    ],
];
...
$demo = [
    '药屋少女的呢喃' => [
        'query' => '药屋少女的呢喃 【喵萌奶茶屋】 简日双语',
    ],
    '盾之勇者成名录S3' => [
        'query' => [
            'keyword' => '盾之勇者成名录 season3 内封',
            'team_id' => '619',
        ],
    ],
    '超超超喜欢你的100个女友' => [
